<?php
namespace CodeLands\MobileLogin\Model\Attribute\Backend;

use Magento\Framework\Exception\LocalizedException;
use CodeLands\MobileLogin\Setup\InstallData;

/**
 * Class MobileNumber
 * @package CodeLands\MobileLogin\Model\Attribute\Backend
 */
